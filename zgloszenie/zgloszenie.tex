...
\begin{document}
	...
	\bibitem {cuda}{ {\bf CUDA ZONE} - \url{http://www.nvidia.pl/object/cuda\_home\_new\_pl.html }}
	\bibitem {opengl}{ {\bf OpenGL - Księga eksperta}, Richard S. Wirdth Jr. Benjamin Lipchak }
	\bibitem {fiz}{ {\bf Fizyka}, R. Resnick, D. Halliday }
	\end{thebibliography}
